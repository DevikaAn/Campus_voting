...
<body>
<?php $conn = new mysqli("localhost","root", "", "votes"); ?>
...
if(isset($_POST['login']))
{
    ...
    {
        $data=array('username'=>$_POST['username'],'pswd'=>$_POST['pswd']);
		include ('LOGIN_QUERY.php');
        if($info=$dao->login($data,'candidate'))
        {
           
            $_SESSION['c_username']=$info['c_username'];
            $_SESSION['sid']=$info['sid'];
            $_SESSION['pswd']=$info['pswd'];
...
$e=$_SESSION['name'];
	...
	echo "<script> alert('Welcome $e to the STUDENT COUNCIL ELECTION');</script> ";	
